...
@jit(forceobj=True)
def numba_color2sepia(n_array_image):
    """
...
if __name__ == '__main__':
    ...
    for _ in range(3):
        ...
        t0 = time()
        s_image = numba_color2sepia(image)
        t1 = time()
        t.append(t1 - t0)
    ...
    # ####################################################### report
    file_name = "numba_report_color2sepia"
    ...
    # ####################################################### testing
    # saving the image
    cv2.imwrite("pictures/numba_sepiascale_image.jpg", s_image)
